...
_itemInfo = switch (_type) do
{
	...
	case "mash": {["water","mash",100,(localize "STR_Process_Mash"),true,"cornmeal"];};
	case "whiskey": {["yeast","whiskey",1000,(localize "STR_Process_FermentingWhiskey"),true,"rye"]};//new
	case "beer": {["yeast","beerp",1500,(localize "STR_Process_BrewingBeer"),true,"hops"]};//new
	case "moonshine": {["yeast","moonshine",250,(localize "STR_Process_Moonshining"),true,"mash"]};//new
	case "bottledshine": {["moonshine","bottledshine",500,(localize "STR_Process_BootleMoonshine"),true,"bottles"]};//new
	case "bottledbeer": {["beerp","bottledbeer",500,(localize "STR_Process_BottleBeer"),true,"bottles"]};//new
	case "bottledwhiskey": {["whiskey","bottledwhiskey",500,(localize "STR_Process_BottleWhiskey"),true,"bottles"]};//new
    default {[]};
