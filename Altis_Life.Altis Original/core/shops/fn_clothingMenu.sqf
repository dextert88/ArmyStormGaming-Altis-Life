...
//Cop / Civ Pre Check
if((_this select 3) in ["bruce","dive","reb","kart","Private_Military"] && playerSide != civilian) exitWith {hint localize "STR_Shop_NotaCiv"; closeDialog 0;};
...
if((_this select 3) == "admin" && !license_civ_Admin) exitWith {hint "You are not an admin."; closeDialog 0;};
