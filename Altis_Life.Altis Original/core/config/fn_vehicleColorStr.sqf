...
switch (_vehicle) do
{
	...
	case "C_Hatchback_01_sport_F":
	{
		switch(_index) do
		{
			...
			case 4: {_color = "Tan"};
			case 5: {_color = "Green"};
			case 6: {_color = "Police (PAT)"};
      case 7: {_color = "Unmarked (PAT)"};
      case 8: {_color = "Abu Dhabi"};
      case 9: {_color = "Monster"};
      case 10: {_color = "Monster #2"};
	...
	case "C_SUV_01_F":
	{
		switch (_index) do
		{
			...
			case 1: {_color = "Unmarked (PAT)";};
			case 2: {_color = "Silver";};
			case 3: {_color = "Orange";};
			case 4: {_color = "Police";};
			case 5: {_color = "Paramedic"};
      case 6: {_color = "ANPR Interceptor (PAT)"};
      case 7: {_color = "Black"};
