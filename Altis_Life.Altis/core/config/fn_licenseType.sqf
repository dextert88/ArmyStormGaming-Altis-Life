...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "mechanic": {_var = "car_service_shop"}; //mechanic License cost
			...
			case "Private_Military": {_var = "license_civ_Private_Military"};
			case "Admin": {_var = "license_civ_Admin"};// admin license
			case "Air_Shop": {_var = "license_civ_air"};// air shop license
			default {_var = ""};
		};
	};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_civ_Private_Military": {_var = "Private_Military"};
			case "license_cop_bounty": {_var = "bounty"};
			case "license_civ_Admin": {_var = "Admin"};
			case "license_civ_airShop": {_var = "Air_Shop"};// air shop license
			default {_var = ""};
		};
	};
};
